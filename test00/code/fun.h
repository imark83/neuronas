...
void fun (real_t t, real_t *x, real_t series[NCOL][ORDER+1]) {
	...
	__constant real_t par[] = {THSYN,ESYN,GSYN,ENA,GNA,EK,GK2,EL,GL,C,TNA,TK2,VSHIFT,IAPP};
...
void fun_SN (real_t t, real_t *x, real_t series[3][ORDER+1]) {
