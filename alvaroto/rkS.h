...
real_t rkStepS (real_t xNext[NVAR_S], real_t x[NVAR_S], real_t h, real_t fsal[NVAR_S], 
...
real_t rkS (real_t x[NVAR_S], real_t tf, char event, real_t vshift) {
	...
	while (t<tf && !endOfIntegration) {
		fac = rkStepS (xNext, x, step, fsal, eventFlag, eventVal, vshift);
