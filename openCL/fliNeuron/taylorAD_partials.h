...
// rop = op1 + op2
void dp_sumAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op1[NDER+1][ORDER+1], 
...
void dp_smCAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op1[NDER+1][ORDER+1],
		real_t op2) {
	int i;
	if (order == 0) 
		rop[0][0] = op1[0][0] + op2;
...
// rop = op1 * op2
void dp_mulAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op1[NDER+1][ORDER+1],
		real_t op2[NDER+1][ORDER+1]) {
	int i, j, vi;
	real_t aux;
	for (i=0; i<=NDER; i++) {
...
// rop = op1 * op2,	op2 constant
void dp_mlCAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op1[NDER+1][ORDER+1],
		real_t op2) {
	int i;
	for (i=0; i<=NDER; i++)
...
void dp_invAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op[NDER+1][ORDER+1],
		real_t p) {
	int i, j, vi;
	real_t ht;
	real_t aux;
...
// rop = op1 / op2
void dp_divAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op1[NDER+1][ORDER+1],
		real_t op2[NDER+1][ORDER+1]) {
	int i, j, vi;
	real_t ht, aux;
	for (i=0; i<=NDER; i++) {
...
// rop = exp (op)
void dp_expAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op[NDER+1][ORDER+1]) {
	int i, j, vi;
	real_t ht, aux;
	if (order == 0) {
		rop[0][0] = exp (op[0][0]);
...
// rop = op1 ^ op2,	op2 constant
void dp_powAD_partials (int order, real_t rop[NDER+1][ORDER+1], real_t op1[NDER+1][ORDER+1],
		real_t op2) {
	int i, j, vi;
	real_t ht, aux;
