...
// GEOMETRY VALUES
#define M		(60)		// HORIZONTAL GRIDSIZE
#define N		(60)		// VERTICAL GRIDSIZE
#define CUTNUMBER	(150)		// NUMBER OF CUTS FOR POINC. OF EACH NEURON!
#define CENTERX		(0.001)
#define CENTERY		(0.001)
#define RADIUS		(0.05)
...
#define TOL		(1.0e-9)	// TOLERANCE FOR THE RUNGE-KUTTA INTEGRATION
